  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Provedor - Your ultimate solution for internet providers, offering a comprehensive and efficient CRUD system."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1597733336794-12d05021d510?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxpbnRlcm5ldHxlbnwwfHx8fDE2ODk4NzE5NTh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Provedor - Your ultimate solution for internet providers, offering a comprehensive and efficient CRUD system.`}
            </Text>
            <Box
